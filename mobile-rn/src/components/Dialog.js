...
const styles = StyleSheet.create({
  ...
  cancel: { flex: 1, minHeight: 48, borderRadius: 24, borderWidth: 1, borderColor: colors.cardBorder, alignItems: 'center', justifyContent: 'center' },
  confirm: { flex: 1, minHeight: 48, borderRadius: 24, backgroundColor: colors.accent, alignItems: 'center', justifyContent: 'center' },
