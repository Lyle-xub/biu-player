...
const styles = StyleSheet.create({
  ...
  search: { flex: 1, minWidth: 0, height: 48, paddingHorizontal: 12, flexDirection: 'row', alignItems: 'center', gap: 8,
  ...
  sort: { width: 48, height: 48, flexShrink: 0, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 2,
  ...
  option: { width: '48%', flexGrow: 1, minWidth: 145, minHeight: 48, paddingHorizontal: 12,
