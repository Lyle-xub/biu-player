...
const styles = StyleSheet.create({
  ...
  card: { marginHorizontal: 2, marginTop: 6, marginBottom: 12, padding: 16, borderRadius: 22, borderWidth: 1, borderColor: colors.cardBorder, backgroundColor: colors.accentSoft, flexDirection: 'row', alignItems: 'center', gap: 16 },
  ...
  button: { minHeight: 48, justifyContent: 'center', paddingHorizontal: 13, borderRadius: 24, backgroundColor: colors.card }, on: { backgroundColor: colors.accentSoft },
  ...
  playAll: { flex: 1, flexDirection: 'row', justifyContent: 'center', alignItems: 'center', gap: 7, minHeight: 48, paddingHorizontal: 12, borderRadius: 24, backgroundColor: colors.accent },
  playText: { color: colors.bg, fontSize: 14, fontWeight: '600' },
  saveButton: { flexDirection: 'row', alignItems: 'center', gap: 5, minHeight: 48, paddingHorizontal: 12, borderRadius: 24, backgroundColor: colors.card, borderWidth: 1, borderColor: colors.cardBorder },
  actionText: { color: colors.text, fontSize: 12 },
  refreshButton: { width: 48, height: 48, alignItems: 'center', justifyContent: 'center', borderRadius: 24, backgroundColor: colors.card },
